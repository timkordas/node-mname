...
Query.prototype.reset = function () {
        ...
        Object.setPrototypeOf(r.header.flags, q.header.flags);
...
function parseEdns() {
        ...
        if (typeof (q.additional) === 'object') {
                ...
                if (edns) {
                        this.maxReplySize = edns.rclass;
                        if (this.maxReplySize > 1200)
                                this.maxReplySize = 1200;
                        r.additional.push({
                                name: '.',
                                rtype: queryTypes['OPT'],
                                rclass: this.maxReplySize,
                                rttl: 0,
                                rdata: { options: [] }
                        });
                        r.header.arCount++;
...
Query.prototype.encode = function encode(recurse) {
        ...
        if (encoded.length > this.maxReplySize) {
                if (recurse)
                        throw (new Error('Truncated answer message still ' +
